...
import { CheckTokenResponse, LoginResponse, User } from '../interfaces/index.interface';
...
export class AuthService {
  ...
  setLocalStorage(item: string, content: string ) {
    if (typeof localStorage !== 'undefined') {
      localStorage.setItem(item,content);
    }
  }

  getLocalStorage(item: string ): string|null {
    if (typeof localStorage !== 'undefined') {
